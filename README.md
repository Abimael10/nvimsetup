...
- Launch `:Mason` after the first start to watch LSPs/formatters install (Bash, Go, Java, Lua, Markdown, Python, Rust, TypeScript, etc.).
...
- **Language tooling**:
  - Mason auto-installs LSPs/formatters/debuggers for Bash, Go, HTML, Java, JavaScript/TypeScript, Lua, Markdown, Python, Rust, and more (`lua/config/plugins/mason.lua`).
...
- **Treesitter**: Installs parsers for web, systems, data, and scripting stacks (JS/TS/TSX, HTML/CSS, Rust, Go, Python, Java, Bash, Lua, etc.) with large-file guards (`lua/config/plugins/treesitter.lua`).
- **UI polish**:
